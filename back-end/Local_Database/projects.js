export default [
  ...
  },
  {
    ...
    description:
      "Since its founding in 2011, TSWGO has helped hundreds of families, with gifts totaling over $450,000 to help families suffering from financial hardship related to childhood cancer. We're helping to streamline this system so that TSWGO can focus their attention on helping families.",
    image_url:
      "https://images.squarespace-cdn.com/content/v1/5afe1b373e2d09d58a8b7629/1548818988674-PNHSLS67AF1SRNW6JAX4/LOGO_TSWGO_1.png?format=1500w",
    active: true,
  },
  {
    _id: "3",
    ...
    image_url:
      "https://c4cneu-public.s3.us-east-2.amazonaws.com/Site/JPAL_logo.svg",
    active: true,
  },
  {
    _id: "4",
